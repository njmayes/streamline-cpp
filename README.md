...
By executing the `sl::Application::Run` function, the application instance will be created and the event loop will be started on the current thread. This will be a headless application with no GUI.
