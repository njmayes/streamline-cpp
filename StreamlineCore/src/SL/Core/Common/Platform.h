...
* it has __linux__ defined */
    ...
    #define SL_COMPILER_NAME "Clang"
#elif defined(__GNUC__)
    #define SL_COMPILER_GCC
    #define SL_COMPILER_NAME "gcc"
#elif defined(__MINGW32__) || defined(__MINGW64__)
    #define SL_COMPILER_MINGW
    #define SL_COMPILER_NAME "MinGW"
#elif defined(__INTEL_COMPILER)
    #define SL_COMPILER_INTEL
    #define SL_COMPILER_NAME "Intel"
#else
    /* Unknown platform */
