...
namespace slc {
    ...
    public:
        ...
        template<typename Function, typename... Args> requires ReturnValuedFunction<Function, Args...>
        ...
        template<typename Function, typename... Args> requires VoidFunction<Function, Args...>
